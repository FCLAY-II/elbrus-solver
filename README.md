...
Сервис предназначен для людей, которые только начинают свой путь в изучение JavaScipt, MVP проекта было создано за 2 дня, пользователь может зарегистрироваться/авторизоваться и переходить к решению задач, он будет оповещен когда решит верно или нет ту или иную задачу, а также введеться статистика пользователя.
<br/>
